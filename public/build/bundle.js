...
var app = (function () {
    ...
    const file$4 = "src/LetterBoxRow.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 16, 4, 382);
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "row-container svelte-a0mcq1");
    			add_location(div, file$4, 14, 0, 297);
    		},
    ...
    class LetterBoxRow extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { wordLength: 0, wordToGuess: 1, word: 2 });
    ...
    const file$3 = "src/LetterBoxContainer.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 10, 0, 216);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src/WinLossContainer.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 28, 8, 705);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 26, 12, 634);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "win-lose-message svelte-wp0nvw");
    			add_location(div, file$2, 24, 12, 534);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    class WinLossContainer extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { gameState: 0, handleReset: 1 });
    ...
    /* src/MainHeader.svelte generated by Svelte v3.59.2 */

    const file$1 = "src/MainHeader.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			h1 = element("h1");
    			h1.textContent = "YURTLE";
    			attr_dev(h1, "class", "main-title svelte-9dkxzz");
    			add_location(h1, file$1, 2, 8, 47);
    			add_location(div, file$1, 1, 4, 33);
    			attr_dev(header, "class", "main-header svelte-9dkxzz");
